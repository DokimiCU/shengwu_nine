...
local capture = function(user, pointed_thing)
  ...
  if minetest.is_protected(pointed_thing.under, name) then
    ...
    minetest.sound_play("lab_tool_bad", {gain = 0.2, pos = pos, max_hear_distance = 5})
    return
  end
  ...
  if minetest.get_item_group(node_name, "live_bot") == 1 then
    ...
    if inv:get_stack("main", 1) == "ecobots2:specimen_container" then
      ...
      minetest.sound_play("lab_tool_good", {gain = 0.2, pos = pos, max_hear_distance = 5})
		else
...
minetest.register_craftitem("lab:specimen_sampler", {
	description = "Specimen Sampler",
	inventory_image = "lab_analyzer.png",
	stack_max = 1,
...
minetest.register_craftitem("lab:specimen_container", {
	description = "Specimen Container",
	inventory_image = "lab_specimen_empty.png",
	stack_max = 1,

})

--saved specimen
minetest.register_craftitem("lab:specimen", {
...
minetest.register_craftitem("lab:metab_inducer", {
...
minetest.register_craftitem("lab:feed_injector", {
...
minetest.register_craftitem("lab:light_meter", {
...
minetest.register_craftitem("lab:mutagenic_probe", {
...
minetest.register_craftitem("lab:spore_inducer", {
...
minetest.register_craftitem("lab:analyzer", {
